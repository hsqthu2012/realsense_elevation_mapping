...
bool ElevationMapping::updatepointsMapLocation(const ros::Time& timeStamp)
{
  ...
  // ROS_INFO("trackPointFrameId_ = %s, map_.getFrameId() = %s", trackPointFrameId_.c_str(), map_.getFrameId().c_str()); // added by Suqin He for debugging
...
bool ElevationMapping::updateMapLocation()
{
  ...
  // ROS_INFO("current_p = (%f, %f, %f)", current_p[0], current_p[1], current_p[2]); // added by Suqin He for debugging
